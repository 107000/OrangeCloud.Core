...
namespace OrangeCloud.Core
{
    public static class AiType
    {
        ...
        /// <param name="obj"></param>
        /// <returns></returns>
        public static bool DynamicIn(this object my, object obj)
        {
            return true;
        }
        ...
        public static bool DynamicGreaterThan(this object my, object obj)
        {
            return true;
        }
        public static bool DynamicLessThan(this object my, object obj)
        {
            return true;
        }
