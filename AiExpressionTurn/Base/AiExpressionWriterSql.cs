...
namespace OrangeCloud.Core.AiExpression
{
    ...
    internal class AiExpressionWriterSql : AiExpressionVisitor
    {
            ...
            else
            {
                switch (Type.GetTypeCode(c.Value.GetType()))
                {
                    ...
                    case TypeCode.Object:
                        if (c.Value.GetType() == typeof(List<int>))
                        {
                            var obj = (List<int>)c.Value;
                        ...
                        else if (c.Value.GetType() == typeof(List<int?>))
                        {
                            var obj = (List<int?>)c.Value;
                            for (int i = 0; i < obj.Count; i++)
                            {
                        ...
                        else if (c.Value.GetType() == typeof(List<long>))
                        {
                            var obj = (List<long>)c.Value;
                            for (int i = 0; i < obj.Count; i++)
                            {
                                if (i > 0)
                                    this.Write(",");
                        ...
                        else if (c.Value.GetType() == typeof(List<short>))
                        {
                            var obj = (List<short>)c.Value;
                            for (int i = 0; i < obj.Count; i++)
                            {
                                if (i > 0)
                                    this.Write(",");
                        ...
                        else if (c.Value.GetType() == typeof(List<decimal>))
                        {
                            var obj = (List<decimal>)c.Value;
                            for (int i = 0; i < obj.Count; i++)
                            {
                                if (i > 0)
                                    this.Write(",");
                        ...
                        else if (c.Value.GetType() == typeof(List<string>))
                        {
                            var obj = (List<string>)c.Value;
                            for (int i = 0; i < obj.Count; i++)
                            {
                                if (i > 0)
                                    this.Write(",");
                                this.Write("N'");
                                this.Write(obj[i].Safe());
                                this.Write("'");
                            }
                            break;
                        }
                        ...
                        else if (c.Value.GetType() == typeof(Int64?[]))
                        {
                            var obj = (long?[])c.Value;
                            for (int i = 0; i < obj.Length; i++)
                            {
                                if (i > 0)
                                    this.Write(",");
                        ...
                        else if (c.Value.GetType() == typeof(Int16?[]))
                        {
                            var obj = (short?[])c.Value;
                            for (int i = 0; i < obj.Length; i++)
                            {
                                if (i > 0)
                                    this.Write(",");
        ...
        protected override Expression VisitMethodCall(MethodCallExpression m)
        {
            ...
            else if (m.Method.DeclaringType == typeof(AiType))
            {
                switch (m.Method.Name)
                {
                    case "Like":
